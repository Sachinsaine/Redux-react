              ...
              <div className="space-y-5">
                <div>
                  ...
                  <div>
                    <Field
                      ...
                      placeholder="Email"
                    />
                    <span className="text-red-600 fw-bold">
                ...
                <div>
                  <Link
                    to="/"
                    type="button"
                    className="inline-flex w-full no-underline items-center justify-center rounded-md bg-black px-3.5 py-1.5 font-semibold leading-7 text-white hover:bg-black/80"
                  >
                    Cancel
                  </Link>
                </div>
